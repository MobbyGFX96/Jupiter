...
import com.jupiter.override.ReliantChat;
...
public class GuiIngame extends Gui {
    ...
    private final ReliantChat persistantChatGUI;
    ...
    public GuiIngame(Minecraft minecraft) {
        this.mc = minecraft;
        this.persistantChatGUI = new ReliantChat(minecraft);
