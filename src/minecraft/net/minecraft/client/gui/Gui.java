...
public class Gui {
    ...
    public void drawCenteredString(FontRenderer fontRenderer, String displayString, int x, int y, int colour) {
        fontRenderer.drawStringWithShadow(displayString, x - fontRenderer.getStringWidth(displayString) / 2, y, colour);
    }
