...
import com.jupiter.override.ClientPlayerControllerMP;
import com.jupiter.override.OverlayHook;
...
public class Minecraft implements IPlayerUsage {
    ...
    public ClientPlayerControllerMP playerController;
    ...
    private void startGame() throws LWJGLException {
        ...
        Display.setTitle(Jupiter.getInstance().getClientName() + " 1.7.10");
        ...
        this.ingameGUI = new OverlayHook(this);
        ...
        if (this.currentScreen == null || this.currentScreen.field_146291_p) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    Jupiter.getInstance().getModuleManager().onKeyPressed();
                    if (this.currentScreen != null) {
