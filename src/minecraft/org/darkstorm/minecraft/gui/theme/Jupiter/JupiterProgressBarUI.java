...
public class JupiterProgressBarUI extends AbstractComponentUI<ProgressBar> {
    private JupiterTheme theme;

    public JupiterProgressBarUI(JupiterTheme theme) {
    ...
    protected void renderComponent(ProgressBar component) {
        ...
        GuiUtils.getInstance().drawGradientRect(0, 0, area.width * barPercentage, area.height, 0x90EF8927, 0x90E4531C);
